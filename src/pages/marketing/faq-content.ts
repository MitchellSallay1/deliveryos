/** Shared with src/lib/seo/page-head.ts so the FAQPage JSON-LD (rendered client-side and at build-time by scripts/prerender.mjs) is built from the exact same Q&A copy shown on the page — never a separate, driftable copy. */
